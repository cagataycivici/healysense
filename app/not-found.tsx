                ...
                <div className={`relative min-h-[47rem] lg:h-[84rem] ${isWide ? '' : 'rounded-3xl bg-main-gradient shadow-black-card lg:rounded-4xl'}`}>
                    <div className="relative z-20">
                        ...
                        <div className="mt-8 flex flex-col items-center px-4 pb-20 lg:mt-24">
                            <svg className="w-1/2 sm:w-1/4 lg:w-[396px]" viewBox="0 0 396 396" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                ...
                                <path
                                    ...
                                    fill="url(#paint1_linear_notFound)"
                                />
                                <path
                                    ...
                                    fill="url(#paint2_linear_notFound)"
                                />
                                <defs>
                                    <linearGradient id="paint0_linear_notFound" x1="198" y1="0" x2="198" y2="396.004" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#F37021" />
                                        <stop offset="1" stopColor="#FF8C42" stopOpacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint1_linear_notFound" x1="198" y1="0" x2="198" y2="396.004" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#F37021" />
                                        <stop offset="1" stopColor="#FF8C42" stopOpacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint2_linear_notFound" x1="198" y1="0" x2="198" y2="396.004" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#F37021" />
                                        <stop offset="1" stopColor="#FF8C42" stopOpacity="0" />
                                    </linearGradient>
                                </defs>
