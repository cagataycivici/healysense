...
const Testimonials = () => {
    ...
    return (
        <div className="container flex flex-col items-center justify-start gap-14 bg-white pb-8 pt-16">
            <div className="flex w-full max-w-[1152px] flex-col items-center justify-start gap-4">
                <div
                ...
                {testimonials.map((testimonial, index) => (
                    <AnimatedContainer key={index} delay={index * 100} className="flex h-full flex-col justify-between gap-8 rounded-[28px] bg-white p-6 outline outline-1 outline-offset-[-1px] outline-surface-200">
                        <div className="flex flex-1 flex-col items-start justify-start gap-2">
                            <div className="relative size-[40px] overflow-hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                                    <path
