...
const TravelDestinationPlan = () => {
    return (
        <div className="container flex lg:flex-row flex-col items-center gap-18 mt-24 lg:mt-64">
            <div className="max-w-[26rem] lg:max-w-none lg:flex-1 w-full h-[51rem] relative rounded-3xl lg:rounded-4xl overflow-hidden shadow-blue-card dark:shadow-black-card">
                <Image fill sizes="auto" className="object-cover -z-2" src="/pages/travel/destination-plan-bg.jpg" alt="Destination Plan Image" />
            ...
            <div className="lg:flex-1">
                <span className="badge">World Explore</span>
                <h1 className="text-5xl font-semibold text-surface-950 dark:text-surface-0 leading-tight mt-3.5">Plan Your Holiday For Wonderful Discoveries</h1>
                <p className="mt-5 text-surface-500 dark:text-white/64 text-lg">Essential tips for planning your vacation, from choosing destinations to maximizing your trip.</p>
                <div className="mt-14 flex flex-col gap-8">
                    <div>
                        <h5 className="text-2xl font-medium leading-tight text-surface-950 dark:text-surface-0">Research Your Destination</h5>
                        <p className="mt-4 text-lg text-surface-500 dark:text-white/64">Learn about the culture, climate, and attractions through guides, forums, and blogs.</p>
                    </div>
                    <div>
                        <h5 className="text-2xl font-medium leading-tight text-surface-950 dark:text-surface-0">Budget Wisely</h5>
                        <p className="mt-4 text-lg text-surface-500 dark:text-white/64">Estimate costs for lodging, food, transport, and activities. Compare prices to save money.</p>
                    </div>
                    <div>
                        <h5 className="text-2xl font-medium leading-tight text-surface-950 dark:text-surface-0">Book in Advance</h5>
                        <p className="mt-4 text-lg text-surface-500 dark:text-white/64">Reserve flights, lodging, and tours early for the best deals and stress-free planning.</p>
                    </div>
                    <div>
                        <h5 className="text-2xl font-medium leading-tight text-surface-950 dark:text-surface-0">Pack Smart</h5>
                        <p className="mt-4 text-lg text-surface-500 dark:text-white/64">Make a packing list based on weather and activities. Include travel documents and essentials.</p>
                    </div>
                </div>
            </div>
        </div>
...
export default TravelDestinationPlan;
