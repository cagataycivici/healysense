...
const LogisticTeam: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className, ...props }) => {
    return (
        <div className={cn('container mt-64', className)} {...props}>
            <div className="max-w-[40rem] lg:mx-auto">
                <h1 className="text-3xl lg:text-7xl font-semibold text-surface-950 dark:text-surface-0">Meet Our Leadership Team</h1>
                <p className="mt-7 text-lg lg:text-xl text-surface-500 dark:text-white/64">
            ...
            <div className="mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px rounded-4xl overflow-hidden">
